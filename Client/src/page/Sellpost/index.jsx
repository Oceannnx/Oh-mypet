          ...
          <div className="grid grid-col-1 xl:grid-cols-2 m-6">
            ...
            <divv className="flex flex-col p-5">
              <div className="grid grid-cols-2 divide-x-2">
                <div className="xl:px-10 px-4 border border-solid border-t-2 border-b-2 border-blue1">
              ...
              <div className="flex py-4 lg:text-xl text-sm border border-b-2 border-blue1">
